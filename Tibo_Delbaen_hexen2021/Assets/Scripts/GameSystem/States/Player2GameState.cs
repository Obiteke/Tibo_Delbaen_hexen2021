...
{
    public class Player2GameState : GameStateBase
    {
        ...
        public Player2GameState(Board<HexenPiece> board, HexenPiece player, Deck<CardBase> deck, Hand<CardBase> hand, GameLoop gameLoop)
        {
            _board = board;
            _player = player;
            _deck = deck;
