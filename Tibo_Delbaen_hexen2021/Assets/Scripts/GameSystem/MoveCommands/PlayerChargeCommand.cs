...
{
    public class PlayerChargeCommand : AbstractBasicMoveCommand
    {
        public PlayerChargeCommand(ReplayManager replayManager) : base(replayManager)
        {
        }
        ...
        */
        public override List<Tile> Tiles(Board<HexenPiece> board, HexenPiece piece)
        {
            ...
            var validTiles = new HexMovementHelper(board, piece, 3)
                .NorthEast(1)
